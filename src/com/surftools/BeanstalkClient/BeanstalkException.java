...
public class BeanstalkException extends RuntimeException {
    protected BeanstalkExceptionType reason = null;
    
	private static final long serialVersionUID = 5592298800830452296L;

	public BeanstalkException(String message) {
		super(message);
        reason = BeanstalkExceptionType.OTHER;
	}
    
    public BeanstalkException(BeanstalkExceptionType et) {
		super(et.getExeptionMessage());
        reason = et;
	}
    public BeanstalkException(BeanstalkExceptionType et, String message) {
		super(message);
        reason = et;
	}
    public BeanstalkExceptionType getReason() {
        return reason;
    }
